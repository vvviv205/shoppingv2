...
export default function Form({ single }) {
  ...
  return (
    <>
      <div className="absolute w-full bg-slate-200/15 backdrop-blur-md  h-screen mt-12 sm:mt-0 z-50  inset-0  flex justify-center items-center transition-all duration-150">
